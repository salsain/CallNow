...
public class RecordingThread {
    ...
    private static final String ACTIVE_UMDL1 = Constants.ACTIVE_UMDL1;
    private static final String ACTIVE_UMDL2 = Constants.ACTIVE_UMDL2;
    ...
    private String activeModel = strEnvWorkSpace + File.separatorChar + ACTIVE_UMDL1 + "," + strEnvWorkSpace+File.separatorChar + ACTIVE_UMDL2;
    ...
    public RecordingThread(Handler handler, AudioDataReceivedListener listener) {
        ...
        detector.SetSensitivity("0.5,0.5");
        detector.SetAudioGain(2);
        detector.ApplyFrontend(true);
        try {
            player.setDataSource(strEnvWorkSpace+File.separatorChar+"ding.wav");
            player.prepare();
        } catch (IOException e) {
    ...
    private void record() {
        ...
        while (shouldContinue) {
            ...
            if (result == -2) {
                ...
                Log.i("KeyWord: ", "Hotword " + Integer.toString(result) + " detected!");
                player.start();
            }
        }
    ...
    public boolean getRecordingState(){
        return shouldContinue || thread != null;
    }
}
