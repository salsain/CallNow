...
public class ZoomWelcomeActivity extends Activity implements ZoomConstants, ZoomSDKInitializeListener, ZoomSDKAuthenticationListener ,OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null) {
			sdk.initialize(this, ZOOM_APP_KEY, ZOOM_APP_SECRET, ZOOM_WEB_DOMAIN, this);
		}
	}
	...
	private void showApiExampleActivity() {
		//Intent intent = new Intent(this, ZoomWorkEmailUserExampleActivity.class);
		Intent intent = new Intent(this, ZoomCallSequenceActivity.class);
		startActivity(intent);
	}
