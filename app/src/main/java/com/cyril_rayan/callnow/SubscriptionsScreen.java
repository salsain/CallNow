...
public class SubscriptionsScreen extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
        OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subscriptions_screen);
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(SubscriptionsScreen.this);
    ...
    public void onUpgradeAppButtonClicked(View arg0) {
        ...
        try {
            mHelper.launchPurchaseFlow(this, SKU_MORE_THEN_5_CALLS, RC_REQUEST,
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        if (!StaticMemory.getInstance().enableSalesForceFeature || !mAutoRenewEnabled) {
        ...
        int titleResId;
        if (!StaticMemory.getInstance().enableSalesForceFeature) {
    ...
    public void updateUi() {
        ...
        ((TextView)findViewById(R.id.moreThen5CallsEnabled)).setText(StaticMemory.getInstance().enableMore5CallsFeature ? "More Then 5 calls enabled" : "You have not feature \"more then 5 calls\"");
        //findViewById(R.id.more_then_5_calls).setVisibility(StaticMemory.getInstance().enableMore5CallsFeature ? View.GONE : View.VISIBLE);
        findViewById(R.id.more_then_5_calls).setEnabled(StaticMemory.getInstance().enableMore5CallsFeature ? false : true);

        ((TextView)findViewById(R.id.salesForceEnabled)).setText(StaticMemory.getInstance().enableSalesForceFeature ? "SalesForce enabled" : "You have not feature \"SalesForce\"");
        Button infiniteGasButton = (Button) findViewById(R.id.infinite_gas_button);

        if (StaticMemory.getInstance().enableSalesForceFeature) {
            // If subscription is active, show "Manage Infinite Gas"
            infiniteGasButton.setText("(YOU HAVE IT)Manage SalesForce CRM");
        } else {
            infiniteGasButton.setText("GET SalesForce CRM");
        }
    }
