...
public class PrepareSnowboyActivityCopy extends AppCompatActivity {

    private static final String TAG = PrepareSnowboyActivityCopy.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prepare_snowboycopy);
        ...
        generate_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    generateNewModel();
                    Toast.makeText(PrepareSnowboyActivityCopy.this, "Successfully download!", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(PrepareSnowboyActivityCopy.this, WelcomeScreen.class);
